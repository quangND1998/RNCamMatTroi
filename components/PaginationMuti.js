                ...
                (<Box className="flex">
                    <Box className="flex flex-row ">
                        <PressableOpacity onPress={() => {
                            ...
                            <Box variant="unstyled" className="px-2 py-2" isDisabled={data.current_page === 1 ? true : false}>
                        ...
                        <Text className="px-2 py-2">{data.current_page}/{data.last_page}</Text>
                        <PressableOpacity onPress={() => {
                            changePage(data.current_page + 1)

                        }} disabled={data.current_page === data.last_page ? true : false}>
                            <Box className="px-2 py-2" variant="unstyled" isDisabled={data.current_page === data.last_page ? true : false}>
